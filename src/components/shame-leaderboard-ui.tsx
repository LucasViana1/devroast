...
interface ShameLeaderboardUIProps {
  data: {
    topThree: TopShameEntry[];
    totalRoasts: number;
  };
}

export function ShameLeaderboardUI({ data }: ShameLeaderboardUIProps) {
  ...
  return (
    <>
      ...
      <p className="mt-4 text-center font-secondary text-xs text-text-tertiary">
        showing top 3 of {data.totalRoasts.toLocaleString()} roasts ·{" "}
